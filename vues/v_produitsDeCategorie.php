...
{ 	// récupération des informations du produit
	...
	<div class="card">
			...
			<div class="imgCard"><a href="index.php?uc=voirProduits&categorie=<?php echo $categorie ?>&produit=<?php echo $id ?>&action=ajouterAuPanier&pact=<?php echo $_REQUEST['action'] ?>"> 
